...
use MelonCart\Shop\Models\Category as CategoryModel;
...
class Category extends ComponentBase
{
     ...
     * @var \MelonCart\Shop\Models\Category
     */
    public $category;
    ...
    public function componentDetails()
    {
        return [
            'name'        => 'Category',
            'description' => 'Displays a list of Products in a given Category.'
        ];
    }
    ...
    public function onRun()
    {
        ...
        $this->category = $this->page['category'] = $this->loadCategory($slug);
        $this->products = $this->page['products'] = $this->category ?
            $this->listProducts($this->category, ['page' => $page]) :
            [];
    ...
    protected function listProducts(CategoryModel $category, array $options = [])
    {
    ...
    {
        return CategoryModel::findByNestedSlug($slug);
    }
