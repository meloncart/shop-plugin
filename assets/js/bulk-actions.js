...
+function ($) { "use strict";
    ...
    BulkActions.prototype.onClickPrimaryButton = function() {
        ...
        if ( this.activeControl )
            this.$primaryBtn.attr('data-control', this.activeControl)
        else
            this.$primaryBtn.removeAttr('data-control')
        ...
        console.log("set", this.$primaryBtn[0], this.activeControl)
    }
    ...
    BulkActions.prototype.setActiveItem = function($el) {
        ...
        this.activeControl = $el.data('control')
